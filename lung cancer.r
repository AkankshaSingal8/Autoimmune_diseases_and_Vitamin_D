...
gset <- getGEO("GSE4115", GSEMatrix =TRUE, AnnotGPL=TRUE)
...
gsms <- paste0("01X1111111X111111111XX11X1X11111111X111X11X1X1X1X1",
        "X1X11111000X000000000X000000000000000000000XX00000",
        "00000000000000X0000000000000001X1111X111111111X1X1",
        "1X11111111111111111100000000000000000XXXXX")
...
gs <- factor(sml)
groups <- make.names(c("grp1 ","grp 2"))
levels(gs) <- groups
gset$group <- gs
